...
Every call goes to `CALL_TEST_NUMBER` (+32000000000), never to the business.

## 1. Twilio
1. Create an account and buy a voice number (US numbers are instant; Belgian numbers need a regulatory bundle).
2. Trial account: add +32000000000 under *Phone Numbers → Verified Caller IDs*.
